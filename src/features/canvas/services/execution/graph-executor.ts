  ...
  export class GraphExecutor {
    constructor(private readonly sandbox: SandboxInstance, private readonly runtime: ExecutionRuntime) {}
    ...
    private async executeNode(
      ...
      await this.runtime.runStep(
        `node-${node.id}`,
        () => executor(node, nodes, edges, context, sandbox)
      )
